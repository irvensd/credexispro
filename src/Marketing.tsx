    ...
    <div className="max-w-3xl mx-auto px-2 sm:px-4 py-12 flex flex-col items-center justify-center min-h-[60vh]">
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex flex-col items-center gap-4 bg-white rounded-2xl shadow-xl p-10 border border-indigo-100">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-lg font-bold text-indigo-700">Marketing</span>
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="text-xl font-semibold text-gray-800 text-center">Unlock Advanced Marketing Tools</div>
          <div className="text-gray-500 text-center max-w-md">Access powerful marketing tools, analytics, and automation features to grow your business and reach more clients.</div>
        </div>
